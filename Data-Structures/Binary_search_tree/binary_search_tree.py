# Code contains whole binary search tree.
# It contains two classes TreeNode and BinarySearchTree.
# Class TreeNode contains node and BinarySearchTree contains tree and its operations. 
